...
def classify_shigella(assembly, minimap2_index, ref_file, min_identity, min_coverage, shigella_serotype_markers):
    """
    ...
    - ref_file: Reference file containing serotype marker sequences.
