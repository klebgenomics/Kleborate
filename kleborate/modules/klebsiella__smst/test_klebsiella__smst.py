...
def test_check_cli_options_1():
    Args = collections.namedtuple('Args', ['klebsiella__smst_min_identity', 'klebsiella__smst_min_coverage',
                                           ...
                                           'klebsiella__smst_required_exact_matches', 'klebsiella__smst_min_gene_count'])
    check_cli_options(Args(klebsiella__smst_min_identity=90.0, klebsiella__smst_min_coverage=80.0,
                           klebsiella__smst_min_spurious_identity=80.0, klebsiella__smst_min_spurious_coverage=40.0,
                           klebsiella__smst_required_exact_matches=2, klebsiella__smst_min_gene_count=2))
...
def test_check_cli_options_2():
    ...
    with pytest.raises(SystemExit):
        check_cli_options(Args(klebsiella__smst_min_identity=0.90, klebsiella__smst_min_coverage=80.0,
                               klebsiella__smst_min_spurious_identity=80.0, klebsiella__smst_min_spurious_coverage=40.0,
                               klebsiella__smst_required_exact_matches=2, klebsiella__smst_min_gene_count=2))
...
def test_check_cli_options_4():
    Args = collections.namedtuple('Args', ['klebsiella__smst_min_identity', 'klebsiella__smst_min_coverage',
                                           ...
                                           'klebsiella__smst_required_exact_matches', 'klebsiella__smst_min_gene_count'])
    with pytest.raises(SystemExit):
        check_cli_options(Args(klebsiella__smst_min_identity=-10.0, klebsiella__smst_min_coverage=80.0,
                               klebsiella__smst_min_spurious_identity=80.0, klebsiella__smst_min_spurious_coverage=40.0,
                               klebsiella__smst_required_exact_matches=2, klebsiella__smst_min_gene_count=2))
...
def test_check_cli_options_7():
    ...
    with pytest.raises(SystemExit):
        check_cli_options(Args(klebsiella__smst_min_identity=90.0, klebsiella__smst_min_coverage=80.0,
                               klebsiella__smst_min_spurious_identity=80.0, klebsiella__smst_min_spurious_coverage=40.0,
                               klebsiella__smst_required_exact_matches=2, klebsiella__smst_min_gene_count=-1))
