...
def description():
    return 'In silico serotyping of K and O locus for the Klebsiella oxytoca species complex'
...
def add_cli_options(parser):
    ...
    group.add_argument('--kosc-k-db', type=str, default='kosc_k', metavar='',
                       help="Kaptive database for K-locus typing (default: kosc_k)")
    group.add_argument('--kosc-o-db', type=str, default='kosc_o', metavar='',
                       help="Kaptive database for O-locus typing (default: kosc_o)")
    return group
...
def check_cli_options(args):
    args.k_db = load_or_install_db(args.kosc_k_db)
    args.o_db = load_or_install_db(args.kosc_o_db)
