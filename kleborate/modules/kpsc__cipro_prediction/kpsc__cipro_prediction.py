...
def get_results(assembly, minimap2_index, args, previous_results):
    ...
    flq_mutations = previous_results['kpsc__amr__Flq_mutations'][0]
    flq_acquired = previous_results['kpsc__amr__Flq_acquired'][0]
    agly_acquired = previous_results['kpsc__amr__AGly_acquired'][0]

    # check presence GyrA-87H and GyrA-87G
    if 'GyrA:p.D87G' in flq_mutations or 'GyrA:p.D87H' in flq_mutations:
