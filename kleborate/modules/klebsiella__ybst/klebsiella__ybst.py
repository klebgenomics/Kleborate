...
def add_cli_options(parser):
    ...
    group.add_argument('--klebsiella__ybst_required_exact_matches', type=int, default=5,
                       help='At least this many exact matches are required to call an ST')
    group.add_argument('--klebsiella__ybst_min_gene_count', type=int, default=6,
...
def check_cli_options(args):
    ...
    if args.klebsiella__ybst_min_gene_count < 0:
        sys.exit('Error: --klebsiella__ybst_min_gene_count must be a positive integer')
...
def get_results(assembly, minimap2_index, args, previous_results):
    ...
    results, spurious_hits = multi_mlst(assembly, minimap2_index, profiles, alleles, genes,
                                      ...
                                      unknown_group_name='ybt unknown',
                                      min_gene_count=args.klebsiella__ybst_min_gene_count)
