...
def test_check_cli_options_1():
    Args = collections.namedtuple('Args', ['klebsiella__ybst_min_identity', 'klebsiella__ybst_min_coverage',
                                           ...
                                           'klebsiella__ybst_required_exact_matches', 'klebsiella__ybst_min_gene_count'])
    check_cli_options(Args(klebsiella__ybst_min_identity=90.0, klebsiella__ybst_min_coverage=80.0,
                           klebsiella__ybst_min_spurious_identity=80.0, klebsiella__ybst_min_spurious_coverage=40.0,
                           klebsiella__ybst_required_exact_matches=5, klebsiella__ybst_min_gene_count=6))
...
def test_check_cli_options_2():
    ...
    with pytest.raises(SystemExit):
        check_cli_options(Args(klebsiella__ybst_min_identity=0.90, klebsiella__ybst_min_coverage=80.0,
                               klebsiella__ybst_min_spurious_identity=80.0, klebsiella__ybst_min_spurious_coverage=40.0,
                               klebsiella__ybst_required_exact_matches=5, klebsiella__ybst_min_gene_count=6))
...
def test_check_cli_options_4():
    Args = collections.namedtuple('Args', ['klebsiella__ybst_min_identity', 'klebsiella__ybst_min_coverage',
                                           ...
                                           'klebsiella__ybst_required_exact_matches', 'klebsiella__ybst_min_gene_count'])
    with pytest.raises(SystemExit):
        check_cli_options(Args(klebsiella__ybst_min_identity=-10.0, klebsiella__ybst_min_coverage=80.0,
                               klebsiella__ybst_min_spurious_identity=80.0, klebsiella__ybst_min_spurious_coverage=40.0,
                               klebsiella__ybst_required_exact_matches=5, klebsiella__ybst_min_gene_count=6))
...
def test_check_cli_options_6():
    ...
    with pytest.raises(SystemExit):
        check_cli_options(Args(klebsiella__ybst_min_identity=90.0, klebsiella__ybst_min_coverage=80.0,
                               klebsiella__ybst_min_spurious_identity=80.0, klebsiella__ybst_min_spurious_coverage=40.0,
                               klebsiella__ybst_required_exact_matches=-2, klebsiella__ybst_min_gene_count=6))
...
def test_check_cli_options_7():
    ...
    with pytest.raises(SystemExit):
        check_cli_options(Args(klebsiella__ybst_min_identity=90.0, klebsiella__ybst_min_coverage=80.0,
                               klebsiella__ybst_min_spurious_identity=80.0, klebsiella__ybst_min_spurious_coverage=40.0,
                               klebsiella__ybst_required_exact_matches=5, klebsiella__ybst_min_gene_count=-1))
...
def test_get_results_2():
    # Tests a genome with multiple ybt loci.
    Args = collections.namedtuple('Args', ['klebsiella__ybst_min_identity', 'klebsiella__ybst_min_coverage',
                                           'klebsiella__ybst_min_spurious_identity', 'klebsiella__ybst_min_spurious_coverage',
                                           'klebsiella__ybst_required_exact_matches', 'klebsiella__ybst_min_gene_count'])
...
def test_get_results_3():
    # Tests an E. coli without the ybt locus, so no ST should be assigned.
    Args = collections.namedtuple('Args', ['klebsiella__ybst_min_identity', 'klebsiella__ybst_min_coverage',
                                           'klebsiella__ybst_min_spurious_identity', 'klebsiella__ybst_min_spurious_coverage',
                                           'klebsiella__ybst_required_exact_matches', 'klebsiella__ybst_min_gene_count'])
