...
#     'stb': {'name': 'ST', 'headers': []},
#     'astA': {'name': 'ST', 'headers': []}
 }


# Load virulence factors from a FASTA file and map headers to the dict
def load_virulence_factors(fasta_file_path):
    """
    Loads virulence factor headers from a FASTA file and maps them to the predefined dictionary.

    Parameters:
    - fasta_file_path (str): Path to the FASTA file.

    Returns:
    - Dictionary with virulence factors mapped to their headers.
    """
