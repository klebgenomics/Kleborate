...
def test_check_cli_options_1():
    Args = collections.namedtuple('Args', ['general__species_strong', 'general__species_weak'])
    check_cli_options(Args(general__species_strong=0.01, general__species_weak=0.05))


def test_check_cli_options_2():
    Args = collections.namedtuple('Args', ['general__species_strong', 'general__species_weak'])
    with pytest.raises(SystemExit):
        check_cli_options(Args(general__species_strong=0.05, general__species_weak=0.01))
...
def test_check_cli_options_4():
    Args = collections.namedtuple('Args', ['general__species_strong', 'general__species_weak'])
    with pytest.raises(SystemExit):
        check_cli_options(Args(general__species_strong=0.01, general__species_weak=1.5))
...
def test_get_results_1():
    ...
    results = get_results(get_test_genome_dir() / 'GCF_000016305.1.fna.gz', None,
                          Args(general__species_strong=0.01, general__species_weak=0.04), {})
...
def test_get_results_2():
    Args = collections.namedtuple('Args', ['general__species_strong', 'general__species_weak'])
    results = get_results(get_test_genome_dir() / 'GCF_000016305.1.fna.gz', None,
                          Args(general__species_strong=0.001, general__species_weak=0.004), {})
    assert results['species'] == 'Klebsiella pneumoniae'
...
def test_get_results_3():
    Args = collections.namedtuple('Args', ['general__species_strong', 'general__species_weak'])
    results = get_results(get_test_genome_dir() / 'GCF_000016305.1.fna.gz', None,
                          Args(general__species_strong=0.0001, general__species_weak=0.0004),
                          {})
