...
class TestSpecies(unittest.TestCase):
    ...
    def test_klebsiella_grimontii(self):
        species, strength = get_klebsiella_species('test/GCF_000733495.1.fna.gz', self.data_folder)
        self.assertEqual(species, 'Klebsiella grimontii')

    def test_klebsiella_michiganensis(self):
        species, strength = get_klebsiella_species('test/GCF_000240325.1.fna.gz', self.data_folder)
        self.assertEqual(species, 'Klebsiella michiganensis')

    def test_klebsiella_oxytoca(self):
        species, strength = get_klebsiella_species('test/GCF_000247855.1.fna.gz', self.data_folder)
        self.assertEqual(species, 'Klebsiella oxytoca')

    def test_klebsiella_pneumoniae(self):
        species, strength = get_klebsiella_species('test/GCF_000016305.1.fna.gz', self.data_folder)
        self.assertEqual(species, 'Klebsiella pneumoniae')

    def test_klebsiella_quasipneumoniae_subsp_quasipneumoniae(self):
        species, strength = get_klebsiella_species('test/GCF_000492415.1.fna.gz', self.data_folder)
    ...
    def test_klebsiella_quasipneumoniae_subsp_similipneumoniae(self):
        species, strength = get_klebsiella_species('test/GCF_000492795.1.fna.gz', self.data_folder)
        self.assertEqual(species, 'Klebsiella quasipneumoniae subsp. similipneumoniae')

    def test_klebsiella_quasivariicola(self):
        species, strength = get_klebsiella_species('test/GCF_000523395.1.fna.gz', self.data_folder)
        self.assertEqual(species, 'Klebsiella quasivariicola')

    def test_klebsiella_variicola_subsp_variicola(self):
        species, strength = get_klebsiella_species('test/GCF_000019565.1.fna.gz', self.data_folder)
        self.assertEqual(species, 'Klebsiella variicola subsp. variicola')

    def test_klebsiella_variicola_subsp_tropicalensis(self):
        species, strength = get_klebsiella_species('test/GCF_002806645.1.fna.gz', self.data_folder)
        self.assertEqual(species, 'Klebsiella variicola subsp. tropicalensis')

    def test_klebsiella_africanensis(self):
        species, strength = get_klebsiella_species('test/ERR2835900.fna.gz', self.data_folder)
        self.assertEqual(species, 'Klebsiella africanensis')

    def test_raoultella_planticola(self):
        species, strength = get_klebsiella_species('test/GCF_000648315.1.fna.gz', self.data_folder)
        self.assertEqual(species, 'Raoultella planticola')

    def test_raoultella_ornithinolytica(self):
        species, strength = get_klebsiella_species('test/GCF_000247895.1.fna.gz', self.data_folder)
        self.assertEqual(species, 'Raoultella ornithinolytica')

    def test_raoultella_terrigena(self):
        species, strength = get_klebsiella_species('test/GCF_000829965.1.fna.gz', self.data_folder)
        self.assertEqual(species, 'Raoultella terrigena')

    def test_salmonella(self):
        species, strength = get_klebsiella_species('test/GCF_004010735.1.fna.gz', self.data_folder)
        self.assertTrue('Salmonella' in species)

    def test_citrobacter(self):
        species, strength = get_klebsiella_species('test/GCF_003937345.1.fna.gz', self.data_folder)
