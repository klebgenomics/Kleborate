...
* L'espèce (par exemple : *K. pneumoniae*\ , *K. quasipneumoniae*\ , *K. variicola*\ , etc.)
...
**De nouveaux modules pour d'autres espèces sont en cours d'élaboration**, pour l'instant, il s'agit notamment de schémas MLST pour le complexe d'espèces *Klebsiella oxytoca* et pour *Escherichia coli* (voir la page Modules).
...
Yersiniabactine et colibactine (*ICEKp*):
...
Lorsque Kleborate v3 est exécuté en utilisant l'option ``-p kpsc`` pour exécuter des modules prédéfinis pour *K. pneumoniae* la même logique est implémentée que dans Kleborate v2, plus les modifications/mises à jour suivantes:
...
Un tutoriel étape par étape pour Kleborate v3 est disponible à `kleborate-workshop <https://docs.google.com/document/d/1R61bQbBngpiDB2Gl_eXigePBVakYZEjy/edit>`_, couvrant:
...
Kleborate est en développement actif avec de nombreux autres outils et projets d'analyse génomique en cours (voir `github.com/klebgenomics <https://github.com/klebgenomics>`_).
