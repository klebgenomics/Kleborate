...
.. list-table:: Virulence markers of diarrheagenic *E. coli* 
   :header-rows: 1

   * - **Pathotype**
     - **Defining marker**
     - **Virulence determinants**
     - **Location of virulence determinants**
     - **Major diagnostic targets for PCR**
...
.. list-table:: *E. coli* Pathovar outputs
   :header-rows: 1
...
Kleborate includes a module for subtyping of the LEE pathogenicity island. Details of the LEE subtypes and lineages can be found in this `Nature Microbiology paper <https://www.nature.com/articles/nmicrobiol201510>`.
...
.. list-table:: Serotype prediction metadata
   :header-rows: 0
...
.. list-table:: Antimicrobial resistance classes
   :header-rows: 0
